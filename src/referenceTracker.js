...
export function getReferencesTo(referenceMap: ReferenceMapType<*>, toEntity: string) {
...
export function deleteAllReferencesTo(referenceMap: ReferenceMapType<*>, toEntity: string) {
